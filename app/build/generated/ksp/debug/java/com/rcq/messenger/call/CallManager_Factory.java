...
public final class CallManager_Factory implements Factory<CallManager> {
  ...
  public CallManager get() {
    return newInstance(contextProvider.get(), webSocketManagerProvider.get(), jsonProvider.get());
  }

  public static CallManager_Factory create(Provider<Context> contextProvider,
      Provider<WebSocketManager> webSocketManagerProvider, Provider<Json> jsonProvider) {
    return new CallManager_Factory(contextProvider, webSocketManagerProvider, jsonProvider);
  }

  public static CallManager newInstance(Context context, WebSocketManager webSocketManager,
      Json json) {
    return new CallManager(context, webSocketManager, json);
  }
}
