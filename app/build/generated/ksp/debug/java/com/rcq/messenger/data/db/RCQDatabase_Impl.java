...
public final class RCQDatabase_Impl extends RCQDatabase {
  ...
  private volatile PendingOutboxDao _pendingOutboxDao;
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(13) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS `contacts` (`userId` INTEGER NOT NULL, `nickname` TEXT NOT NULL, `avatarUrl` TEXT, `status` TEXT NOT NULL, `lastSeen` TEXT, `isBlocked` INTEGER NOT NULL, `isFavorite` INTEGER NOT NULL, `notificationSound` TEXT, `customNickname` TEXT, `addedAt` INTEGER NOT NULL, `identityKey` TEXT, `signingKey` TEXT, PRIMARY KEY(`userId`))");
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS `pending_outbox` (`localId` TEXT NOT NULL, `chatId` TEXT NOT NULL, `recipientUin` INTEGER NOT NULL, `isGroup` INTEGER NOT NULL, `plainContent` TEXT NOT NULL, `messageKind` TEXT NOT NULL, `retryCount` INTEGER NOT NULL, `maxRetries` INTEGER NOT NULL, `createdAt` INTEGER NOT NULL, PRIMARY KEY(`localId`))");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '0737cbada3346f81d0529de5d560d7bd')");
      }
      ...
      public void dropAllTables(@NonNull final SupportSQLiteDatabase db) {
        ...
        db.execSQL("DROP TABLE IF EXISTS `pending_outbox`");
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        _columnsContacts.put("identityKey", new TableInfo.Column("identityKey", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsContacts.put("signingKey", new TableInfo.Column("signingKey", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        final HashMap<String, TableInfo.Column> _columnsPendingOutbox = new HashMap<String, TableInfo.Column>(9);
        _columnsPendingOutbox.put("localId", new TableInfo.Column("localId", "TEXT", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsPendingOutbox.put("chatId", new TableInfo.Column("chatId", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsPendingOutbox.put("recipientUin", new TableInfo.Column("recipientUin", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsPendingOutbox.put("isGroup", new TableInfo.Column("isGroup", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsPendingOutbox.put("plainContent", new TableInfo.Column("plainContent", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsPendingOutbox.put("messageKind", new TableInfo.Column("messageKind", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsPendingOutbox.put("retryCount", new TableInfo.Column("retryCount", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsPendingOutbox.put("maxRetries", new TableInfo.Column("maxRetries", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsPendingOutbox.put("createdAt", new TableInfo.Column("createdAt", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        final HashSet<TableInfo.ForeignKey> _foreignKeysPendingOutbox = new HashSet<TableInfo.ForeignKey>(0);
        final HashSet<TableInfo.Index> _indicesPendingOutbox = new HashSet<TableInfo.Index>(0);
        final TableInfo _infoPendingOutbox = new TableInfo("pending_outbox", _columnsPendingOutbox, _foreignKeysPendingOutbox, _indicesPendingOutbox);
        final TableInfo _existingPendingOutbox = TableInfo.read(db, "pending_outbox");
        if (!_infoPendingOutbox.equals(_existingPendingOutbox)) {
          return new RoomOpenHelper.ValidationResult(false, "pending_outbox(com.rcq.messenger.domain.model.PendingOutboxEntity).\n"
                  + " Expected:\n" + _infoPendingOutbox + "\n"
                  + " Found:\n" + _existingPendingOutbox);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "0737cbada3346f81d0529de5d560d7bd", "bea4ac806b1f4625971bce94afe6b32a");
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "users","contacts","chats","messages","groups","stories","story_items","calls","signal_keys","pending_outbox");
  }
  ...
  public void clearAllTables() {
    ...
    try {
      ...
      _db.execSQL("DELETE FROM `pending_outbox`");
  ...
  protected Map<Class<?>, List<Class<?>>> getRequiredTypeConverters() {
    ...
    _typeConvertersMap.put(PendingOutboxDao.class, PendingOutboxDao_Impl.getRequiredConverters());
  ...
  @Override
  public PendingOutboxDao pendingOutboxDao() {
    if (_pendingOutboxDao != null) {
      return _pendingOutboxDao;
    } else {
      synchronized(this) {
        if(_pendingOutboxDao == null) {
          _pendingOutboxDao = new PendingOutboxDao_Impl(this);
        }
        return _pendingOutboxDao;
      }
    }
