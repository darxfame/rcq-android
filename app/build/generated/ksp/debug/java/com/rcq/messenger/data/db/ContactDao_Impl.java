...
public final class ContactDao_Impl implements ContactDao {
  ...
  private final SharedSQLiteStatement __preparedStmtOfUpdateSigningKey;
  ...
  public ContactDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfContactEntity = new EntityInsertionAdapter<ContactEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `contacts` (`userId`,`nickname`,`avatarUrl`,`status`,`lastSeen`,`isBlocked`,`isFavorite`,`notificationSound`,`customNickname`,`addedAt`,`identityKey`,`signingKey`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        if (entity.getIdentityKey() == null) {
          statement.bindNull(11);
        } else {
          statement.bindString(11, entity.getIdentityKey());
        }
        if (entity.getSigningKey() == null) {
          statement.bindNull(12);
        } else {
          statement.bindString(12, entity.getSigningKey());
        }
      }
    };
    ...
    this.__preparedStmtOfUpdateSigningKey = new SharedSQLiteStatement(__db) {
      @Override
      @NonNull
      public String createQuery() {
        final String _query = "UPDATE contacts SET signingKey = ? WHERE userId = ?";
        return _query;
      }
    };
  }
  ...
  @Override
  public Object updateSigningKey(final long userId, final String signingKey,
      final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
        final SupportSQLiteStatement _stmt = __preparedStmtOfUpdateSigningKey.acquire();
        int _argIndex = 1;
        _stmt.bindString(_argIndex, signingKey);
        _argIndex = 2;
        _stmt.bindLong(_argIndex, userId);
        try {
          __db.beginTransaction();
          ...
          __preparedStmtOfUpdateSigningKey.release(_stmt);
        }
      }
    }, $completion);
  }
    ...
    return CoroutinesRoom.createFlow(__db, false, new String[] {"contacts"}, new Callable<List<ContactEntity>>() {
      ...
      public List<ContactEntity> call() throws Exception {
        ...
        try {
          ...
          final int _cursorIndexOfIdentityKey = CursorUtil.getColumnIndexOrThrow(_cursor, "identityKey");
          final int _cursorIndexOfSigningKey = CursorUtil.getColumnIndexOrThrow(_cursor, "signingKey");
          ...
          while (_cursor.moveToNext()) {
            ...
            final String _tmpIdentityKey;
            if (_cursor.isNull(_cursorIndexOfIdentityKey)) {
              _tmpIdentityKey = null;
            } else {
              _tmpIdentityKey = _cursor.getString(_cursorIndexOfIdentityKey);
            }
            final String _tmpSigningKey;
            if (_cursor.isNull(_cursorIndexOfSigningKey)) {
              _tmpSigningKey = null;
            } else {
              _tmpSigningKey = _cursor.getString(_cursorIndexOfSigningKey);
            }
            _item = new ContactEntity(_tmpUserId,_tmpNickname,_tmpAvatarUrl,_tmpStatus,_tmpLastSeen,_tmpIsBlocked,_tmpIsFavorite,_tmpNotificationSound,_tmpCustomNickname,_tmpAddedAt,_tmpIdentityKey,_tmpSigningKey);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public ContactEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new ContactEntity(_tmpUserId,_tmpNickname,_tmpAvatarUrl,_tmpStatus,_tmpLastSeen,_tmpIsBlocked,_tmpIsFavorite,_tmpNotificationSound,_tmpCustomNickname,_tmpAddedAt,_tmpIdentityKey,_tmpSigningKey);
          } else {
            _result = null;
          }
          return _result;
