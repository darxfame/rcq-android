...
import com.rcq.messenger.ui.games.GamesViewModel_HiltModules_KeyModule_ProvideFactory;
import com.rcq.messenger.ui.market.MarketplaceViewModel;
...
public final class DaggerRCQApplication_HiltComponents_SingletonC {
  ...
  private static final class SingletonCImpl extends RCQApplication_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.provideApiServiceProvider = DoubleCheck.provider(new SwitchingProvider<RCQApiService>(singletonCImpl, 1));
      this.provideDatabaseProvider = DoubleCheck.provider(new SwitchingProvider<RCQDatabase>(singletonCImpl, 7));
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.rcq.messenger.data.repository.UserRepository 
          return (T) new UserRepository(singletonCImpl.provideApiServiceProvider.get(), singletonCImpl.userDao());

          case 1: // com.rcq.messenger.data.api.RCQApiService 
          ...
          case 7: // com.rcq.messenger.data.db.RCQDatabase 
          return (T) AppModule_ProvideDatabaseFactory.provideDatabase(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));

          case 8: // com.rcq.messenger.data.repository.ContactRepository 
